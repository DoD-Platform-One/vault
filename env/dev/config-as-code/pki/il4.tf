...
resource "vault_mount" "pki_il4_p1_int" {
  path                  = "pki/il4/p1_int"
  type                  = "pki"
...
# generate p1 il4 csr
resource "vault_pki_secret_backend_intermediate_cert_request" "pki_il4_p1_int" {
  backend = vault_mount.pki_il4_p1_int.path

  type        = "internal"
  common_name = "DoD P1 IL4 Intermediate CA"
  key_type    = "rsa"
  key_bits    = "4096"
...
resource "vault_pki_secret_backend_intermediate_set_signed" "pki_il4_p1_int" {
  backend = vault_mount.pki_il4_p1_int.path

  certificate = vault_pki_secret_backend_root_sign_intermediate.pki_il4_p1_int.certificate
}

# create role
resource "vault_pki_secret_backend_role" "pki_il4_p1_int_leaf" {
  backend            = vault_mount.pki_il4_p1_int.path
